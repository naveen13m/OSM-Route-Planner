...
// References should be initialized with initializer list
RoutePlanner::RoutePlanner(RouteModel &model, float start_x, float start_y, float end_x, float end_y): m_Model(model) {
    ...
    // Store the closest nodes in the RoutePlanner's start_node and end_node attributes.
...
RouteModel::Node *RoutePlanner::NextNode() {
    ...
    // Sort the open_list according to the sum of the h value and g value
    std::sort(this->open_list.begin(), this->open_list.end(), [](const RouteModel::Node* lhs, const RouteModel::Node* rhs )
    {
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
    ...
    while (current_node->parent != nullptr)
    {
        ...
        // Valid parent should exist for this operation to not fail (Ensured by while)
    ...
    // Make start node the first element of the vector and end node to be the last element
